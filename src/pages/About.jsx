  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="text-center mb-12">
        <span className="inline-block bg-blue-100 text-blue-600 text-xs font-semibold px-3 py-1 rounded-full mb-4 uppercase tracking-widest">
          Tentang
        </span>
        <h1 className="text-4xl font-black text-blue-700 mb-4">Tentang Feb LMS</h1>
      ...
      <h2 className="text-xl font-bold text-blue-700 mb-4">Tech Stack</h2>
      <div className="grid sm:grid-cols-2 gap-4 mb-12">
        {stack.map((s) => (
          <div key={s.name} className="bg-white rounded-2xl shadow-md border border-slate-100 p-5 flex gap-4">
            ...
            <div>
              <p className="font-bold text-blue-700 text-sm">{s.name}</p>
      ...
      <h2 className="text-xl font-bold text-blue-700 mb-4">Fitur yang Dibangun</h2>
